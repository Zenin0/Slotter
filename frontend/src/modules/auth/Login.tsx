...
function Login() {
    ...
    return (
        <div className="min-h-screen bg-gray-100 flex items-center justify-center px-4">
            ...
            {/* Error notification */}
            {error && (
                <div className="fixed top-5 left-1/2 -translate-x-1/2 z-50 flex items-center gap-3 bg-red-50 border border-red-300 text-red-700 px-4 py-3 rounded-lg shadow-md">
                    <span>⚠️ {error}</span>
